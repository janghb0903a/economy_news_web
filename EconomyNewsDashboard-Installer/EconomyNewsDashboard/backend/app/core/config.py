...
class Settings(BaseSettings):
    ...
    report_final_time: str = "17:30"
    report_email_enabled: bool = False
    report_email_time: str = "17:50"
    ...
    enable_alert_domestic_all: bool = True
    enable_alert_domestic_bok: bool = False
    enable_alert_global: bool = False
